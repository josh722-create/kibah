...
<footer class="footer-kibah">
    <div class="footer-contenido">

        <!-- Columna 1: Logo -->
        <div class="footer-col footer-logo">
            <img src="{{ asset('imagenes/logo.png') }}" alt="Kibah Logo">
        </div>
        ...
        <div class="footer-col">
            <h4>ENLACES RÁPIDOS</h4>
            <a href="tel:+525527150540">+52 5527150540</a>
            <a href="mailto:contacto@kibah.com.mx">contacto@kibah.com.mx</a>
        </div>
